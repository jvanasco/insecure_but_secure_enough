...
payload = {'3b837ba7facceaa': 110466813, 'ad255d1ad80c9': 63879546, 'f85711697': 576164405, '0fd602335': 606091169, '8be808c9f636e09': 380277405, 'd12b0': 372015325, '031a2583a5812b': 893746556, '5e7587d8': 32400442, '9e5ebd40596c84': 645607501}
...
def ise_serialized_plaintext_decode():
    valid = factories['ise-signing'].serialized_plaintext_decode(computed['ise-signing:serialized_plaintext_encode'])
...
def ise_hmac_sha1_decode():
    valid = factories['ise-signing'].hmac_sha1_decode(computed['ise-signing:hmac_sha1_encode'])
...
def ise_hmac_sha256_decode():
    valid = factories['ise-signing'].hmac_sha256_decode(computed['ise-signing:hmac_sha256_encode'])
...
n = 100
statements = [
    """tests['ise_rsa_encrypt']()""", """tests['ise_rsa_decrypt']()""", """tests['ise_rsa_roundtrip']()""",
    """tests['ise_aes_encrypt']()""", """tests['ise_aes_decrypt']()""", """tests['ise_aes_roundtrip']()""",
    """tests['ise_serialized_plaintext_encode']()""", """tests['ise_serialized_plaintext_decode']()""", """tests['ise_serialized_plaintext_roundtrip']()""",
    """tests['ise_hmac_sha1_encode']()""", """tests['ise_hmac_sha1_decode']()""", """tests['ise_hmac_sha1_roundtrip']()""",
    """tests['ise_hmac_sha256_encode']()""", """tests['ise_hmac_sha256_decode']()""", """tests['ise_hmac_sha256_roundtrip']()""",
    """tests['ise_signed_request_encode']()""", """tests['ise_signed_request_decode']()""", """tests['ise_signed_request_roundtrip']()""",
]
for s in statements:
